    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-8 drop-shadow-lg">
          ...
          <br />
          <span className="text-[#cae9ff]">FUNZIONALITÀ, FORZA, VITA</span>
        </h2>
        <Button
          variant="default"
          className="bg-[#5fa8d3] hover:bg-[#62b6cb] text-white text-xs tracking-widest px-8 py-3 rounded-md shadow-lg shadow-[#5fa8d3]/40 transition-all hover:shadow-xl hover:shadow-[#5fa8d3]/50 hover:-translate-y-0.5"
        >
          INIZIA OGGI
